        ...
        <section className="mx-auto max-w-6xl px-6 py-20">
            <div className="mb-10 text-center">
                <h2 className="text-3xl font-black tracking-tight sm:text-4xl">
                    Choose your AI speech-to-text provider.
                </h2>
                <p className="mt-3 text-muted-foreground">
                    Ten STT providers are wired up out of the box for voice dictation. Swap any
                    time, compare models, and keep every API key on your machine.
                </p>
            </div>
